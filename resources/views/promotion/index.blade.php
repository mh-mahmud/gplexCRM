...
<div class="row">
	<div class="col-xxl-12">
				...
				@if($promotions->isNotEmpty())
					...
					<table
						...
						<tr>
							...
							<td class="text-dark fs-6">{{($promotions->currentPage() - 1) * $promotions->perPage() + $loop->iteration}}</td>
    	...
    	@include('components.pagination', ['paginator' => $promotions])
		...
		{{-- <ul class="pagination mt-2">
			...
			@else
				<li class="page-item previous"><a href="{{ $promotions->previousPageUrl() }}" class="page-link"><i class="previous"></i></a></li>
			@endif
			...
			@if ($promotions->hasMorePages())
				<li class="page-item next"><a href="{{ $promotions->nextPageUrl() }}" class="page-link"><i class="next"></i></a></li>
			@else
