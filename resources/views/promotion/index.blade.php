                    ...
                    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                        ...
                        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                            ...
                            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Promotion
                                ...
                                <!--end::Separator-->
                                <!--begin::Description-->
                                <small class="text-muted fs-7 fw-bold my-1 ms-1">Show Promotion List</small>
                                <!--end::Description--></h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Page title-->
                        ...
                        <div class="d-flex align-items-center py-1">
                            ...
                            <!--end::Wrapper-->
                            <!--begin::Button-->
                            <a href="{{ route('promotion.create') }}" class="btn btn-sm btn-primary" id="kt_toolbar_primary_button">Create</a>
	...
	<div class="col-xxl-12">
		<div class="card mt-5">
			...
			<div class="d-flex justify-content-between align-items-start card-header border-0 pt-1">
				...
				<form action="{{ route('promotion.search') }}" method="POST" class="d-flex">
				@csrf
					<!--begin::Input group-->
					<div class="d-flex align-items-center position-relative">
						...
						<!--end::Svg Icon-->
						<input type="text" name="search" class="form-control form-control-sm form-control-solid w-250px ps-15" value="{{ request('search') }}" placeholder="Search by Promotion Name">
					</div>
					<!--end::Input group-->
				...
				@if($promotions->isNotEmpty())
					...
					<table
						...
						<tr class="fw-bolder">
							...
							<th class="min-w-140px">Promotion Type</th>
						...
						<tr>
							...
							<td class="text-dark fs-6">{{$promotion->promotion_title }}</td>
							<td class="text-dark fs-6">{{ \Carbon\Carbon::parse($promotion->start_date)->format('d-m-Y') }}</td>
							<td class="text-dark fs-6">{{ \Carbon\Carbon::parse($promotion->end_date)->format('d-m-Y') }}</td>
		...
		<ul class="pagination">
			...
			@else
				<li class="page-item previous"><a href="{{ $promotions->previousPageUrl() }}" class="page-link">Previous</a></li>
			@endif
			...
			@for ($page = 1; $page <= $promotions->lastPage(); $page++)
				...
				@else
					<li class="page-item"><a href="{{ $promotions->url($page) }}" class="page-link">{{ $page }}</a></li>
				@endif
			@endfor

			<!-- Next Page Link -->
			@if ($promotions->hasMorePages())
				<li class="page-item next"><a href="{{ $promotions->nextPageUrl() }}" class="page-link">Next</a></li>
			@else
...
<script>
    function confirmDelete() {
        if (confirm("Are you sure you want to delete Promotion?")) {
