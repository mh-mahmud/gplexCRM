            ...
            <div class="col-xxl-12 mx-auto">
                ...
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show @if(session('success') || session('error')) @else active @endif"
                         id="g_lead_details" role="tabpanel">
                        <div class="card">
                    ...
                    <div class="tab-pane fade show @if(session('success') || session('error')) active @endif"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-3">
                                        <div class="g-lead-details mb-5" style="columns: 1">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="g-lead-details mb-5" style="columns: 2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="g-lead-details mb-5" style="columns: 3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="g-lead-details mb-5" style="columns: 4">
                                    ...
                                    <span
                                        class="fs-6 fw-bolder mb-1 text-gray-900 text-hover-primary w-lg-100px w-xxl-150px flex-shrink-0">Form Name</span>
                                                    <span>Lorem ipsum dolor sit amet.</span>
                                                </div><div class="d-flex align-items-center gap-2 bg-light p-1 mb-1">
                                    <span
                                        class="fs-6 fw-bolder mb-1 text-gray-900 text-hover-primary w-lg-100px w-xxl-150px flex-shrink-0">Form Name</span>
                                                    <span>Lorem ipsum dolor sit amet.</span>
                                                </div><div class="d-flex align-items-center gap-2 bg-light p-1 mb-1">
