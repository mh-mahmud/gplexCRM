                                                                                            ...
                                                                                            <form class="g-form w-100" action="{{ route('product-specification-update', $productSpecification->id) }}" enctype="multipart/form-data" method="POST">
                                                                                                    ...
                                                                                                    <div class="row">
                                                                                                        ...
                                                                                                        <div class="col-md-4">
                                                                                                            ...
                                                                                                            <select id="product-select-ps-edit-{{ $productSpecification->id }}" class="product-select-ps-edit form-control form-control-sm form-control-solid"
                                ...
                                <div class="row">
                                    <div class="col-md-12 mx-auto">
                                        <form class="g-form w-100" action="{{ route('send-email-process') }}" method="POST">
                                            ...
                                            <!--End Row-->
                                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                                <button type="submit" class="btn btn-primary" id="kt_account_profile_details_submit">Send</button>
                                            </div>
