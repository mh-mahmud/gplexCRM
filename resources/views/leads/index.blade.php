        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <div class="d-flex align-items-center gap-2">
                    <a href="{{ route('leads-upload') }}" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                       data-bs-target="#upload_lead_modal">Upload Lead</a>
                    <a href="{{ route('lead-create') }}" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                       data-bs-target="#add_lead_modal">Create</a>
                </div>
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="fv-row mb-3">
                                    <label class="form-label fw-bolder text-dark">Form Name</label>
                                    <select class="form-control form-control-sm form-control-solid" id="form_id_2"
                                            name="form_id" aria-label="Default select example">
                                        <option value="">Select Form Name</option>
                                        @foreach($formName as $id => $name)
                                            <option value="{{ $id }}">{{ $name }}</option>
                        ...
                        <div class="card-footer d-flex justify-content-end py-0 px-0">
                            <a href="{{ route('lead-index') }}" class="btn btn-light me-2 btn-sm">Reset</a>
                            <button type="button" class="btn btn-primary btn-sm" id="upload_submit_button">Submit
                            </button>
                        </div>
                        <!--end::Textarea-->
                    </div>
                            ...
                            <form action="{{ route('lead-search') }}" method="POST" class="d-flex">
                                ...
                                <div class="d-flex align-items-center position-relative">
                                    ...
                                    <input type="text" name="search"
                                           ...
                                           value="{{ request('search') }}" placeholder="Search by Lead Name">
                                </div>
                                <!--end::Input group-->
