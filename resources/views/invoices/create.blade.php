    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <!--end::Wrapper-->
                <!--begin::Button-->
                <a href="{{ route('invoice-index') }}" class="btn btn-sm btn-primary" id="kt_toolbar_primary_button">Invoice
                    List</a>
                <!--end::Button-->
            </div>
            <!--end::Actions-->
            ...
            <div class="col-xxl-12">
                <div class="card card-xxl-stretch mt-4">
                    ...
                    <div class="card-body">
                        ...
                        <form class="g-form g-proposal w-100" action="{{ route('invoice-store') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="fv-row mb-5">
                                                ...
                                                <select class="form-control form-control-sm form-control-solid"
                                                        name="customer_id" aria-label="Default select example">
                                        ...
                                        <div class="col-md-12">
                                            <div class="fv-row mb-5">
                                                <label class="form-label fw-bolder text-dark" for="textarea">Bill
                                                    To</label>
                                            ...
                                            <div class="fv-row mb-5">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    @if($errors->has('invoice_number'))
                                                        <span
                                                            class="text-danger">{{ $errors->first('invoice_number') }}</span>
                                                    @endif
                                                </div>
                                                <!--end::Input-->
                                            </div>
                                            ...
                                            <div class="fv-row mb-5">
                                                ...
                                                <div class="position-relative">
                                                    <input type="text"
                                                           ...
                                                           placeholder="Date" name="invoice_date"
                                                           value="{{ old('invoice_date') }}">
                                                    @if ($errors->has('invoice_date'))
                                                        <span
                                                            class="text-danger">{{ $errors->first('invoice_date') }}</span>
                                                    @endif
                                                </div>
                                        ...
                                        <div class="col-xl-6">
                                            <div class="fv-row mb-5">
                                                ...
                                                <select id="custom-invoice-select"
                                                        class="form-control form-control-sm form-control-solid"
                                                        name="custom_invoice_id" aria-label="Default select example">
                                                    <option
                                                        value="" {{ old('custom_invoice_id') === null ? 'selected' : '' }}>
                                                        Nothing Selected
                                                    </option>
                                                ...
                                                @if ($errors->has('custom_invoice_id'))
                                                    <span
                                                        class="text-danger">{{ $errors->first('custom_invoice_id') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="fv-row mb-5">
                                                <label class="form-label fw-bolder text-dark">Allowed payment modes for
                                                    this invoice

                                                </label>
                                                <select class="form-control form-control-sm form-control-solid"
                                                        name="payment_mode" aria-label="Default select example">
                                                    <option value="" {{ old('payment_mode') == '' ? 'selected' : '' }}>
                                                        Nothing Selected
                                                    </option>
                                                    <option
                                                        value="Bank" {{ old('payment_mode') == 'Bank' ? 'selected' : '' }}>
                                                        Bank
                                                    </option>
                                                    <option
                                                        value="Stripe Checkout" {{ old('payment_mode') == 'Stripe Checkout' ? 'selected' : '' }}>
                                                        Stripe Checkout
                                                    </option>
                                                </select>
                                                ...
                                                @if ($errors->has('payment_mode'))
                                                    <span
                                                        class="text-danger">{{ $errors->first('payment_mode') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                            ...
                                            <div class="fv-row mb-5">
                                                ...
                                                <select class=" form-control form-control-sm form-control-solid"
                                                    ...
                                                    @foreach($currencies as $currency)
                                                        <option
                                                            value="{{$currency->id}}" {{ old('currency') == $currency->id ? 'selected' : '' }}>{{ $currency->name }} </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="fv-row mb-5">
                                                ...
                                                <select class="form-control form-control-sm form-control-solid"
                                                        name="invoice_status" aria-label="Default select example">
                                                    @foreach(config('constants.invoice_status') as $key => $status)
                                                        <option
                                                            value="{{ $key }}" {{ old('invoice_status', $loop->first ? $key : '') == $key ? 'selected' : '' }}>{{ $status }}</option>
                                                    @endforeach
                                                </select>

                                                @if ($errors->has('invoice_status'))
                                                    <span
                                                        class="text-danger">{{ $errors->first('invoice_status') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="fv-row mb-5">
                                                ...
                                                <select class="form-control form-control-sm form-control-solid"
                                                    ...
                                                    <!-- Default option -->
                                                    <option
                                                        value="" {{ old('sale_agent_id') === null ? 'selected' : '' }}>
                                                        Nothing Selected
                                                    </option>
                                                    ...
                                                    @foreach($agents as $agent)
                                                        @if($isAdmin)
                                                            <option
                                                                value="{{ $agent->agent_id }}" {{ old('sale_agent_id') == $agent->agent_id ? 'selected' : '' }}>
                                                                {{ $agent->first_name }} {{ $agent->last_name }}
                                                            </option>
                                                        @elseif($agent->user_id == Auth::user()->id)
                                                            <option
                                                                value="{{ $agent->agent_id }}" {{ old('sale_agent_id') == $agent->agent_id ? 'selected' : 'selected' }}>
                                                                {{ $agent->first_name }} {{ $agent->last_name }}
                                                            </option>
                                                            <input type="hidden" name="sale_agent_id"
                                                ...
                                                @if ($errors->has('sale_agent_id'))
                                                    <span
                                                        class="text-danger">{{ $errors->first('sale_agent_id') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="fv-row mb-5">
                                                ...
                                                <select class="form-control form-control-sm form-control-solid"
                                                        name="discount_type_name" aria-label="Default select example">
                                                    <option
                                                        value="" {{ old('discount_type_name') === null ? 'selected' : '' }}>
                                                        Nothing Selected
                                                    </option>
                                                    @foreach($discountTypes as $type)
                                                        <option
                                                            value="{{ $type }}" {{ old('discount_type_name') == $type ? 'selected' : '' }}>
                                                            {{ $type }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-12">
                                            <div class="fv-row mb-5">
                                                <label class="form-label fw-bolder text-dark" for="textarea">Admin
                                                    Note</label>
                                                <textarea class="form-control form-control-sm  form-control-solid"
                                                          id="admin_note" name="admin_note"
                                                          rows="3">{{ old('admin_note') }}</textarea>
                            ...
                            <div class="my-3 overflow-hidden">
                                ...
                                <div class="card">
                                        ...
                                        <div class="card-header p-0">
                                            <div
                                                ...
                                                <div>
                                                    <!--begin::Both add-ons-->
                                                    <div
                                                        class="input-group input-group-sm min-w-300px w-100 w-md-500px">
                                                        <div class="flex-grow-1">
                                                            <select
                                                                class="form-select form-select-sm rounded-end-0 border-end"
                                                                data-control="select2"
                                                                name="product_id" data-placeholder="Add an item"
                                                                id="product-select">
                                                                <option
                                                                    value="" {{ old('product_id') == '' ? 'selected' : '' }}>
                                                                    Nothing Selected
                                                                </option>
                                                        ...
                                                        <span class="input-group-sm input-group-text"><i
                                                                class="bi bi-plus fs-4"></i></span>
                                                    </div>
                                                    <!--end::Both add-ons-->
                                                </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <textarea class="form-control form-control-sm min-w-250px"
                                                                  name="items[item_name][]" cols="30" rows="2"
                                                                  id="item-name" placeholder="Item Name"
                                                                  readonly>{{ old('items.item_name.0') }}</textarea>
                                                    ...
                                                    <td>
                                                        <textarea class="form-control form-control-sm min-w-250px"
                                                                  name="items[description][]" cols="30" rows="2"
                                                                  id="item-description"
                                                                  placeholder="Description">{{ old('items.description.0') }}</textarea>
                                                    ...
                                                    <td>
                                                        <input class="form-control form-control-sm" type="number"
                                                               name="items[quantity][]" id="item-quantity"
                                                               placeholder="Quantity"
                                                               value="{{ old('items.quantity.0') }}">
                                                    ...
                                                    <td>
                                                        <input class="form-control form-control-sm" type="number"
                                                               name="items[rate][]" id="item-rate" placeholder="Rate"
                                                               value="{{ old('items.rate.0') }}">
                                                        @error('items.rate.0')
                                                        <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                    </td>
                                                    ...
                                                    <td>
                                                        <select class="form-select form-select-sm" name="items[tax][]">
                                                            <option
                                                                value="0.00" {{ old('items.tax.0') == '0.00' ? 'selected' : '' }}>
                                                                No Tax (0.00%)
                                                            </option>
                                                            <option
                                                                value="5.00" {{ old('items.tax.0') == '5.00' ? 'selected' : '' }}>
                                                                5.00%
                                                            </option>
                                                            <option
                                                                value="10.00" {{ old('items.tax.0') == '10.00' ? 'selected' : '' }}>
                                                                10.00%
                                                            </option>
                                                            <option
                                                                value="15.00" {{ old('items.tax.0') == '15.00' ? 'selected' : '' }}>
                                                                15.00%
                                                            </option>
                                                        </select>
                                                        @error('items.tax.0')
                                                    ...
                                                    <td>
                                                        <button type="button"
                                                                class="btn btn-sm btn-primary py-2 px-3 add-row">
                                                ...
                                                <div class="table-responsive bg-light-warning rounded-2 p-3">
                                                    <table class="table table-sm table-row-bordered align-middle">
                                                        <tr>
                                                            ...
                                                            <td class="text-end"><strong>BDT</strong> <span
                                                                    id="subtotal-amount">0.00</span></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td class="text-end"><strong>BDT</strong> <span
                                                                    id="discount-amount">-0.00</span></td>
                                                        </tr>
                                                        <!-- New Tax Row -->
                                                        <tr>
                                                            <th class="text-end"><strong>Total Tax:</strong></th>
                                                            <td class="text-end"><strong>BDT</strong> <span
                                                                    id="total-tax-amount">0.00</span></td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td class="text-end"><strong>BDT</strong> <span
                                                                    id="adjustment-amount">0.00</span></td>
                                                        </tr>
                                                        <tr>
                                    ...
                                    <div id="custom-invoice" style="display: block;">
                                        <table id="custom-invoice-table"
                                               class="table table-rounded table-sm table-striped border align-middle gs-2"
                                               style="display: none;">
                                            <thead>
                                            <tr id="custom-invoice-header"
                                                class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200"></tr>
                                            </thead>
                                        ...
                                        <table id="custom-invoice-footer-table"
                                               class="table table-rounded table-sm table-striped border align-middle gs-2"
                                               style="display: none;">
                                            <thead>
                                            <tr id="custom-invoice-footer-header"
                                                class="fw-bold fs-6 text-gray-800 border-bottom border-gray-200"></tr>
                                            </thead>
                                                ...
                                                <div class="table-responsive bg-light-warning rounded-2 p-3">
                                                    <table class="table table-sm table-row-bordered align-middle">
                                                        <tr>
                                                            <th class="text-end"><strong>Sub Total:</strong></th>
                                                            <td class="text-end"><strong>BDT</strong> <span
                                                                    id="custom-subtotal-amount">0.00</span></td>
                                                        </tr>
                                                        <tr>
                                                            <th><strong>VAT :</strong>
                                                                <div class="input-group flex-nowrap">
                                                                    <div class="flex-grow-1">
                                                                        <input
                                                                            class="form-control form-control-sm rounded-end-0 border-end"
                                                                            id="custom_vat" type="number" name="vat"
                                                                            placeholder="VAT">
                                                                    </div>
                                                                    %
                                                                </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-end"><strong>BDT</strong> <span
                                                                    id="custom-total-vat">0.00</span></td>
                                                        </tr>
                                                        <tr>
                                                            <th><strong>Adjustment :</strong>
                                                                <input id="custom_adjustment"
                                                                       class="form-control form-control-sm"
                                                                       type="number" name="custom_adjustment"
                                                                       placeholder="Adjustment"/>
                                                            </th>
                                                        </tr>
                                                        <tr>
                                                            <th class="text-end"><strong>Total</strong></th>
                                                            <td class="text-end">
                                                                <strong>BDT</strong> <span
                                                                    id="custom-total-amount">0.00</span>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="fv-row mb-5">
                                                <label class="form-label fw-bolder text-dark" for="textarea">Client
                                                    Note</label>
                                                <textarea class="form-control form-control-sm  form-control-solid"
                                                          id="client_note" name="client_note"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="fv-row mb-5">
                                                <label class="form-label fw-bolder text-dark" for="textarea">Terms &
                                                    Conditions</label>
                                                <textarea class="form-control form-control-sm  form-control-solid"
