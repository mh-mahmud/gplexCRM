	  ...
	  <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <!--begin::Title-->
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Edit Form
                        <!--begin::Separator-->
                        <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                        <!--end::Separator-->
                        <!--begin::Description-->
                        <small class="text-muted fs-7 fw-bold my-1 ms-1">Edit Proposal</small>
                        <!--end::Description--></h1>
                    <!--end::Title-->
                </div>
                <!--end::Page title-->
                    ...
                    <div class="card card-xxl-stretch mt-4">
                        <div class="card-header bg-light bd-cyan">
                            <div class="card-title m-0">
                                <h3 class="fw-bolder m-0">Edit Proposal</h3>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <form class="g-form g-proposal w-100" action="{{ route('proposal-update', $data->id) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <!--Left Part-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <input class="form-control form-control-sm form-control-solid" type="text" name="subject"  value="{{ $data->subject }}" />
                                                ...
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <select name="lead_id" class=" form-control form-control-sm form-control-solid" aria-label="Default select example">
                                                        ...
                                                        @foreach($leads as $lead)
                                                            <option {{ $data->lead_id==$lead->id ? "selected" : "" }} value="{{ $lead->id }}">{{ $lead->first_name . " " . $lead->last_name }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-12">
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <input class="form-control form-control-sm form-control-solid" value="{{ $data->company_name }}" type="text" name="company_name" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-6">
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control form-control-sm form-control-solid flatpickr date" placeholder="Date" name="start_date" value="{{ $data->start_date }}">
                                            ...
                                            <div class="col-xl-6">
                                                ...
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control form-control-sm form-control-solid flatpickr date" placeholder="Open Till" name="end_date" value="{{ $data->end_date }}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <select class=" form-control form-control-sm form-control-solid" id="currency" name="currency"
                                                        ...
                                                        <option value="{{$currency->name}}" {{ $data->currency == $currency->name ? "selected" : "" }}>
                                                            {{ $currency->name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <input class="form-control form-control-sm form-control-solid" type="text" name="first_name" value="{{ $data->first_name }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <input class="form-control form-control-sm form-control-solid" type="email" id="send_to" name="send_to"  value="{{ $data->send_to }}"/>
                                            ...
                                            <div class="col-md-12">
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <textarea class="form-control form-control-sm  form-control-solid" id="address" name="address" rows="3">{{ $data->address }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <input class="form-control form-control-sm form-control-solid" type="text" id="city" name="city"  value="{{ $data->city }}"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <input class="form-control form-control-sm form-control-solid" type="text" value="{{ $data->status }}" id="state" name="state"  value="{{ old('state') }}"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <select class=" form-control form-control-sm form-control-solid" name="country_name" aria-label="Default select example">
                                                        ...
                                                        <option value="{{$country->name}}" {{ $data->country_name == $country->name ? 'selected' : '' }}>{{ $country->name }} </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="fv-row mb-5">
                                                    ...
                                                    <input class="form-control form-control-sm form-control-solid" type="text" id="zip_code" name="zip_code"  value="{{ $data->zip_code }}"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control form-control-sm form-control-solid" type="text" id="phone" name="phone"  value="{{ $data->phone }}"/>
                                                </div>
                                            </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-header">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table class="table table-rounded table-sm table-striped border align-middle gs-2">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <textarea class="form-control form-control-sm min-w-250px" name="item_name" cols="30" rows="2"placeholder="">{{ $data->item_name }}</textarea>
                                                            @if ($errors->has('item_name'))
                                                                <span class="text-danger">{{ $errors->first('item_name') }}</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                            <textarea class="form-control form-select-sm min-w-250px" name="item_description" cols="30" rows="2"placeholder="Long Description">{{ $data->item_description }}</textarea>
                                                            @if ($errors->has('item_description'))
                                                                <span class="text-danger">{{ $errors->first('item_description') }}</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                            <input id="price" class="form-control form-control-sm" value="{{ $data->price }}" type="number" name="price">
                                                            @if ($errors->has('price'))
                                                                <span class="text-danger">{{ $errors->first('price') }}</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                            <input id="offer_price" value="{{ $data->offer_price }}" class="form-control form-control-sm" type="number" name="offer_price">
                                                        ...
                                                        <td><b><span id="total_amount">{{ $data->offer_price }}</span></b></td>
                                                        <!-- <td>
                                                    ...
                                                    <div class="table-responsive bg-light-warning rounded-2 p-3">
                                                        <table class="table table-sm table-row-bordered align-middle">
                                                            <tr>
                                                                ...
                                                                <td class="text-end"><b><span class="cur-data">BDT</span></b> <span id="sub_total">{{ $data->offer_price }}</span></td>
                                                            </tr>
                                                            <!-- <tr>
                                                            ...
                                                            <tr>
                                                                <th><strong>Tax :</strong>
                                                                    <div class="input-group flex-nowrap">
                                                                        <div class="flex-grow-1">
                                                                            <input id="tax_amount" class="form-control form-control-sm rounded-end-0 border-end" type="text" name="tax_percent" value="{{ $data->tax_percent }}">
                                                                        </div>
                                                                ...
                                                                <td class="text-end"> <b><span class="cur-data">BDT</span></b> <span id="tax_field">{{ $data->tax_amount }}</span></td>
                                                            </tr>
                                                            <tr>
                                                                <th><strong>Discount :</strong>
                                                                    <input id="discount" disabled class="form-control form-control-sm" type="text" name="discount" value="{{ $data->discount }}">
                                                                </th>
                                                                <td class="text-end"><b><span class="cur-data">BDT</span></b>  <span id="discount_right">{{ $data->discount }}</span></td>
                                                            </tr>
                                                            <tr>
                                                                <th class="text-end"><strong>Total with Tax: </strong></th>
                                                                <td class="text-end">
                                                                    <b><span class="cur-data">BDT</span></b> <span id="total_amount_final">{{ $data->total_price }}</span>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
