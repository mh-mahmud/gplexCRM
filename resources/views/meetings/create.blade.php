                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6" id="leadDropdown" style="display: {{ old('recipient_type') == 'lead' ? 'block' : 'none' }}">
                                <div class="fv-row mb-3">
                                    ...
                                    <select id="g-lead-select" class="form-control form-control-sm form-control-solid" name="lead_id[]" multiple="multiple" data-allow-clear="true" data-kt-select2="select2">
                                        <option value="">Select Lead</option>
                                        @foreach($leads as $lead)
                                        <option value="{{ $lead->id }}" {{ old('lead_id') == $lead->id ? 'selected' : '' }}>{{ $lead->first_name }}</option>
                                        @endforeach
                                    </select>
