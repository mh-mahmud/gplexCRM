                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-inline-flex justify-content-end gap-1 w-100 border-bottom-0">
                                            <a href="{{ route('lead-index', $leadsForm->form_id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                            ...
                                            <a href="{{ route('leadsform-show', $leadsForm->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                <!--begin::Svg Icon | path: icons/duotune/general/gen019.svg-->
                                                <span class="svg-icon svg-icon-3">
                                            ...
                                            <a href="{{ route('leadsform-edit', $leadsForm->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
