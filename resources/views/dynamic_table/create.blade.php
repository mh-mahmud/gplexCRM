...
@section('content')
            ...
            <div class="col-xxl-12">
                <div class="card card-xxl-stretch mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <form class="g-form w-100" action="{{ route('dynamictable-store') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="row mb-3" id="fields">
                                    <div class="col-md-2">
                                        <div class="fv-row">
                                            ...
                                            <input class="form-control form-control-sm form-control-solid" type="text"
                                                   name="fields[0][name]" autocomplete="off"/>
                                    ...
                                    <div class="col-md-2">
                                        <div class="fv-row">
                                            ...
                                            <select class="form-control form-control-sm form-control-solid"
                                                    name="fields[0][type]" aria-label="Default select example">
                                    ...
                                    <div class="col-md-2">
                                        <div class="fv-row">
                                            ...
                                            <input class="form-control form-control-sm form-control-solid" type="number"
                                                   name="fields[0][character_length]" autocomplete="off"/>
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="fv-row mb-3">
                                            <!--begin::Label-->
                                            <label class="form-label fw-bolder text-dark mb-4">Is Index</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                       name="fields[0][is_index]" value="1">
                                    ...
                                    <div class="col-md-1">
                                        <div class="fv-row mb-3">
                                            <!--begin::Label-->
                                            <label class="form-label fw-bolder text-dark mb-4">Is Null</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                       name="fields[0][is_null]" value="1">
                                    ...
                                    <div class="col-md-2">
                                        <div class="fv-row mb-3">
                                            <!--begin::Label-->
                                            <label class="form-label fw-bolder text-dark mb-4">Is Unique</label>
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                       name="fields[0][is_unique]" value="1">
    ...
    <script>
        function addField() {
            ...
            newFieldGroup.className = 'row mx-0 px-0 my-3 field-group';
