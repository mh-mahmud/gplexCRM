...
<div class="row">
	<div class="col-xxl-12">
				...
				@if($dynamicTables->isNotEmpty())
					...
					<table class="table table-sm table-condensed table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
						...
						<tr class="fw-bolder text-muted bg-light bd-cyan">
							...
							<th class="rounded-end text-end-new min-w-100px text-end">Actions</th>
						</tr>
						</thead>
						<!--end::Table head-->
						<!--begin::Table body-->
		...
		{{-- <ul class="pagination mt-2">
			...
			@else
				<li class="page-item previous"><a href="{{ $dynamicTables->previousPageUrl() }}" class="page-link"><i class="previous"></i></a></li>
			@endif
			...
			@if ($dynamicTables->hasMorePages())
				<li class="page-item next"><a href="{{ $dynamicTables->nextPageUrl() }}" class="page-link"><i class="next"></i></a></li>
			@else
