        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">SMS Template
                    ...
                    <!--end::Separator-->
                    <!--begin::Description-->
                    <small class="text-muted fs-7 fw-bold my-1 ms-1">SMS Template List</small>
                    <!--end::Description--></h1>
                <!--end::Title-->
            </div>
            <!--end::Page title-->
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <a href="{{ route('sms-template-create') }}" class="btn btn-sm btn-primary"
                ...
                <div class="card mt-5">
                    ...
                    <div class="d-flex justify-content-between align-items-start card-header border-0 pt-1">
                        <h3 class="card-title align-items-start flex-column">
                            <span class="card-label fw-bolder fs-3 mb-1">SMS Template List</span>
							...
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
								...
								<path
                                    ...
                                    <input type="text" name="search"
                                           ...
                                           value="{{ request('search') }}" placeholder="Search by SMS Template Title">
                                </div>
                                <!--end::Input group-->
