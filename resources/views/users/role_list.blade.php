				...
				<div class="toolbar" id="kt_toolbar">
                    ...
                    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                        ...
                        <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                            ...
                            <!--begin::Title-->
                            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Role List
                                <!--begin::Separator-->
                                <span class="h-20px border-gray-200 ms-3 mx-2" style="border-left:1px solid #000!important"></span>
                                <!--end::Separator-->
                                <!--begin::Description-->
                                <small class="text-muted fs-7 fw-bold my-1 ms-1">Show all roles</small>
                                <!--end::Description--></h1>
                            <!--end::Title-->
                        </div>
                        <!--end::Page title-->
                        ...
                        <div class="d-flex align-items-center py-1">
                            ...
                            <!--end::Wrapper-->
                            <!--begin::Button-->
                            <a href="{{ route('role-create') }}" class="btn btn-sm btn-primary" id="kt_toolbar_primary_button">Create</a>
	...
	<div class="col-xxl-12">
		<div class="card mt-5">
			...
			<div class="d-flex justify-content-between align-items-start card-header border-0 pt-1">
				...
				<form action="{{ route('role-search') }}" method="POST" class="d-flex">
				@csrf
					<!--begin::Input group-->
					<div class="d-flex align-items-center position-relative">
						...
						<!--end::Svg Icon-->
						<input type="text" name="search" class="form-control form-control-sm form-control-solid w-250px ps-15" value="{{ request('search') }}" placeholder="Search by Role Name">
					</div>
					<!--end::Input group-->
				...
				<div class="table-responsive">
					...
					<table class="table align-middle gs-0 gy-4 table-row-bordered">
						...
						<tr class="fw-bolder text-muted bg-light bd-cyan">
							...
							<th class="min-w-60px">Role Name</th>
							<th class="min-w-180px">Permission Details</th>
						...
						<tr>
							...
							<td class="text-dark fs-6" style="max-width: 200px">{{$user->permission_details }}</td>
