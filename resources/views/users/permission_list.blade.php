    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <!--begin::Button-->
                <a href="{{ route('create-permission') }}" class="btn btn-sm btn-primary"
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <div class="d-flex align-items-center position-relative">
                                ...
                                <input type="text" data-kt-customer-table-filter="search"
                                       class="form-control-sm form-control w-250px ps-15"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-inline-flex justify-content-end gap-1 w-100 border-bottom-0">
                                                ...
                                                <form action="{{ route('permission.destroy', $user->id) }}"
                                                      method="POST"
