    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div class="d-flex align-items-center py-1">
                ...
                <!--end::Wrapper-->
                <!--begin::Button-->
                <a href="{{ URL::to('user-list') }}" class="btn btn-sm btn-primary" id="kt_toolbar_primary_button">User
                    List</a>
                <!--end::Button-->
            </div>
            <!--end::Actions-->
            ...
            <div class="col-xxl-8 mx-auto">
                <div class="card mt-8">
                    ...
                    <div class="card-body py-3">
                            ...
                            <div class="me-7 mb-4">
                                <div class="symbol symbol-100px symbol-lg-140px symbol-fixed position-relative">
                                    @if($user->profile_image != '')
                                        <img src="{{ asset('uploads/agents/' . $user->profile_image) }}"
                                             alt="{{ $user->last_name }}">
                                    @else
                        ...
                        <div class="d-flex align-items-center gap-2 bg-light p-3 mb-1">
                            <span class="fs-6 fw-bolder mb-1 text-gray-900 text-hover-primary w-lg-100px w-xxl-150px flex-shrink-0">Address</span>
