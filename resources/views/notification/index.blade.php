				...
				@if($notifications->isNotEmpty())
					...
					<table class="table table-sm table-condensed table-row-gray-100 align-middle gs-0 gy-3 table-row-bordered">
						...
						<tr>
							...
							<td class="ps-5 text-dark fs-6 w-300px">{{ $notification->lead_first_name . ' ' . $notification->lead_last_name . ' <' . $notification->lead_email . '>' }}</td>
							<td class="text-dark fs-6">{{ \Carbon\Carbon::parse($notification->notify_datetime)->format('Y-m-d h:i A') }}</td>
							<td class="text-dark fs-6 w-300px">{{ $notification->user_first_name . ' ' . $notification->user_last_name . ' <' . $notification->user_email . '>' }}</td>
